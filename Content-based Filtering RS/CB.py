...
class CB(object):
    ...
    def __init__(self, movies_csv):
        self.movies = rd.get_dataframe_movies_csv(movies_csv)
    ...
    def build_model(self):
        ...
        self.tfidf_matrix = mt.tfidf_matrix(self.movies)
        self.cosine_sim = mt.cosine_sim(self.tfidf_matrix)
